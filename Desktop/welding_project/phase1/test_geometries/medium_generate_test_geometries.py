...
writes uniformly scaled STEP files into:
    ...
    phase1/test_geometries/MEDIUM

Usage:
    python medium_generate_test_geometries.py
"""
...
def save_step(filename, *shapes):
    """Write scaled bodies into the MEDIUM test geometry folder."""
...
def clean_output_steps():
    """Keep folders, remove existing STEP/STP files from the MEDIUM output."""
...
def run():
    ...
    try:
        print("=" * 72)
        print("  MEDIUM Welding Test Geometry Generator")
